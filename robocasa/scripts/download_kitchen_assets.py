...
DOWNLOAD_ASSET_REGISTRY = {
    ...
    "fixtures_lw": dict(
        ...
        url="https://utexas.box.com/shared/static/sij606blqsocxxprht7rnynouqnd5mbw.zip",
        folder=os.path.join(robocasa.__path__[0], "models/assets/fixtures"),
        check_folder_exists=False,
    ),
    ### objects ###
    "objs_objaverse": dict(
        ...
        url="https://utexas.box.com/shared/static/plndqhouycuowq1xciub709pdfy0k61o.zip",
    ...
    "objs_lw": dict(
        ...
        url="https://utexas.box.com/shared/static/lfoz2cdfernv0emo499qgsudwyyxuxil.zip",
